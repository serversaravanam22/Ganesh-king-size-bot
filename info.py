...
auth_channel = environ.get('AUTH_CHANNEL', '-1002345928160') #Channel / Group Id for force sub ( make sure bot is admin )
auth_grp = environ.get('AUTH_GROUP', '-1002345928160')
